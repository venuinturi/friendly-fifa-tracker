...
export const PartnersChart = ({ data }: PartnersChartProps) => {
  return (
    <Card>
      <CardHeader>
        ...
        {data.length > 0 ? (
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              />
              <Legend />
              <Bar dataKey="count" name="Games Played" fill={GAME_COLORS[0]} />
              <Bar dataKey="wins" name="Wins" fill={GAME_COLORS[1]} />
              <Bar dataKey="winPercentage" name="Win Rate" fill={GAME_COLORS[3]} />
            </BarChart>
          </ResponsiveContainer>
        ) : (
